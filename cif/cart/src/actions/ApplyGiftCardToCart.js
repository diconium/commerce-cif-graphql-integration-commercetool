...
const ApplyGiftCardToCartLoader = require('../loaders/ApplyGiftCardToCartLoader.js');
...
class ApplyGiftCardToCart {
   ...
   * method used to call load method from applyGiftCardToCart loader class
   */
  __load() {
    return this._versionLoader.load(this.input).then(version => {
      return this.applyGiftCardToCartLoader.load(this.input, version);
    });
  }
