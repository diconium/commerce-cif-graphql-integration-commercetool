...
const mCountryResponse = require('../resources/mCountry.json');
...
describe('getCountry', function() {
  ...
  describe('Unit Tests', () => {
    ...
    it('Query: validate response should always get the Country', () => {
      scope
      ...
      args.variables = { id: 'US' };
      args.query =
        'query Country($id:String!) { country(id: $id) {id,full_name_locale,full_name_english,available_regions {id,code,name }}}';
      return resolve(args).then(result => {
        let response = result.data;
        assert.isUndefined(result.errors);
        expect(response).to.deep.equals(mCountryResponse.data);
      });
    });
  });
});
