...
const CreateCustomerAddressLoader = require('../loaders/CreateCustomerAddressLoader.js');
...
class CreateCustomerAddress {
  ...
  constructor(parameters) {
    ...
    this.getCreateCustomerAddressLoader = new CreateCustomerAddressLoader(
  ...
  __load() {
    return this._versionLoader.load(this.input).then(version => {
      return this.getCreateCustomerAddressLoader.load(this.input, version);
    });
  }
   ...
   */
  __convertData(data) {
    const currentAddress = data[data.length - 1];
